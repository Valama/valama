...
static void show_main_screen (ValamaProject load_project) {
    ...
    var widget_main = new MainWidget();
    UiElement.widget_main = widget_main;
    init_main_widget (widget_main);
...
static void create_new_file() {
    var source_file = ui_create_file_dialog ((ValamaProject) project);
    if (source_file != null) {
